...
import frame from "../assets/Logos/Framer.png";
...
const Skills = ({ page }) => {
  ...
  return (
    <section id="skills-section">
      ...
      >
        ...
        <div id="techLogos">
          <img
            src={HTML}
            alt="HTML5"
            onMouseOver={(e) => handelHover(e.target.alt)}
      ...
      <div
        id="oSkills"
        onMouseOver={() => setOth(true)}
        onMouseLeave={() => setOth(false)}
      >
        ...
        <div id="otherLogos">
          <img
            src={fig}
            alt="Figma"
            onMouseOver={(e) => handelHover2(e.target.alt)}
            onMouseLeave={() => setLogo2("none")}
          />
          <img
            src={frame}
            alt="Framer"
