...
const Projects = ({ page, VW }) => {
  ...
  return (
    <section id="projects-section">
        ...
        {proj === "PR" ? (
          <div>
            ...
            <span className="descContainer">
              <h4 id="pDesc">
                PixelPraise is a simplistically stylish web app where
                photographers can upload and get feedback on their pictures from
                a community of fellow photography enthusiasts
              </h4>
            </span>
          </div>
        ) : proj === "LL" ? (
          <div>
            ...
            <span className="descContainer">
              <h4 id="pDesc">
                The Little Lemon reservation page aesthetically packages all the
                features you would want to see when making a table reservation,
                including dynamically updating availability slots
              </h4>
            </span>
          </div>
        ) : (
          <div>
            ...
            <span className="descContainer">
              <h4 id="pDesc">
                The GreenStreak Energies Ltd. website goes beyond the typical
                corporate websites, featuring satisfying interactivity and a
                responsive layout for seamless use across devices
              </h4>
            </span>
          </div>
        )}
        <div id="pContentBackdrop" />
      </div>
      ...
      <div id="track">
        <div id="GS">
          <span className="pCont">
            <img
              className="projImg I1 unStag"
              alt=""
              src={require("../assets/GS1.png")}
            />
            <div className="brdr B1 unStag"></div>
          </span>
          <span className="pCont">
            <img
              className="projImg I1 stag"
              alt=""
              src={require("../assets/GS2.png")}
            />
        ...
        <div id="LL">
          <span className="pCont">
            <img
              className="projImg I2 unStag"
              alt=""
              src={require("../assets/LL1.png")}
            />
            <div className="brdr B2 unStag"></div>
          </span>
          <span className="pCont">
            <img
              className="projImg I2 stag"
              alt=""
              src={require("../assets/LL2.png")}
            />
        ...
        <div id="PR">
          <span className="pCont">
            <img
              className="projImg I3 stag"
              alt=""
              src={require("../assets/PR1.png")}
            />
            <div className="brdr B3 stag"></div>
          </span>
          <span className="pCont">
            <img
              className="projImg I3 unStag"
              alt=""
              src={require("../assets/PR2.png")}
            />
            <div className="brdr B3 unStag"></div>
          </span>
          <span className="pCont">
            <img
              className="projImg I3 stag"
              alt=""
              src={require("../assets/PR3.png")}
            />
            <div className="brdr B3 stag"></div>
          </span>
        </div>
      ...
      <a
        href="https://github.com/Tochi-Orams/Portfolio"
        target="_blank"
        rel="noreferrer"
        id="port"
      >
      ...
      <div id="APB">
        <div id="allProj">
          {activeProj === "PR" ? (
            ...
            <div id="hovT">
              <h2>Hover over a project to see more details</h2>
            </div>
          ) : (
            <h1>All Projects</h1>
          )}
          <div id="projs">
            <Link to="pixelpraise">
              <div
                className="projCard"
                onMouseEnter={() => setActiveProj("PR")}
                onMouseLeave={() => setActiveProj(title)}
              >
